...
/**
 ...
 2.   [במשתנה amountOfQuestions] לשים לב שבכל נושא צריך לכתוב את כמות השאלות המקסימלית שילקח ממנו 
 3.   amountOfQuestions = מתייחס רק לשאלות שיילקחו בשביל המבחן 

 */


/************************      הכנס כותרת ראשית של הלומדה      ***********************/
const TITLE = "לומדה גנרית ביפ בופ בפ";
